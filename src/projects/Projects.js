...
export const Projects = () => {
    const projects = [
        ...
        {title: 'Todolist', description:'SPA for managing to-do lists and their items.', logo: logoTodolist,linkToGHPage:'https://dallmad.github.io/my_todo/',linkToCode:'https://github.com/Dallmad/it-incubator-todolist'},
